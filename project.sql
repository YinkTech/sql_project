...
-- 4 Population of South America continent in millions
...
-- 9. Rounding
SELECT name, ROUND(population/1000000,2) as Population_in_million, ROUND(gdp/1000000000,2) as GDP_in_billion
FROM world
WHERE continent = 'South America';
